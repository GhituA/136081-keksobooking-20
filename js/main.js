...
var renderPin = function(offers) {
  ...
  element.style.left = offers.location.locationX;
  element.style.top = offers.location.locationY;

  element.querySelector('img').src = offers.author.avatarUrl;
  element.querySelector('img').alt = offers.offer.title;
